...
Ext.define('Ext.util.translatable.Abstract', {
     ...
     * @param {Number} x The current locale on the x axis
     * @param {Number} y The current locale on the y axis
     */
     ...
     * @param {Ext.util.translatable.Abstract} this
     * @param {Number} x The new locale on the x axis
     * @param {Number} y The new locale on the y axis
     */
