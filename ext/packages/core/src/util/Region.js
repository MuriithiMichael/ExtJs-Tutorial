...
Ext.define('Ext.util.Region', function() {
     ...
     * locale. If an "inside" Region is passed, the exclusion also honours
     * that constraint.
     ...
     * @param {Boolean} [allowX=true] Pass `false` to disallow locale along the X axis.
     * @param {Boolean} [allowY=true] Pass `false` to disallow locale along the Y axis.
