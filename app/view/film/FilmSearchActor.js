/**
 * Created by Micah on 21/10/2017.
 */
Ext.define('Insurance.view.film.FilmSearchActor', {
    extend: 'Ext.window.Window',
    xtype: 'search-actor',

    requires: [
        'Insurance.store.film.SearchActors',
    ...
    dockedItems: [{
        ...
        items: [
            ...
            },
            {
                xtype: 'button',
                text: 'Clear',
                glyph: Insurance.util.Glyphs.getGlyph('clear'),
                listeners: {
                    click: 'onClearActors'
                }
            },
