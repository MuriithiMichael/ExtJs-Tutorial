 ...
 * logged out.
 */
Ext.define('Insurance.util.SessionMonitor', {
    singleton: true,
    ...
    window: Ext.create('Ext.window.Window',{
        ...
        items: [{
            xtype: 'container',
            frame: true,
            html: "Your session will automatically after 15 minutes of inactivity. If your session expires, any unsaved data " +
            "will be lost and you will be automatically logged out. </br></br>If you want to continue working click the 'Continue Working'" +
            "button.</br></<br>"
        },{
            xtype: 'label',
            text: ''
        ...
        buttons:[{
            ...
            handler: function () {
                Ext.TaskManager.stop(Insurance.util.SessionMonitor.countDownTask);
                Insurance.util.SessionMonitor.window.hide();
            ...
            handler: function () {
                ...
                //find and invoke your app's logout function
     ...
     */
    countDown: function () {
        this.window.down('label').update('Your session will expire in '+ this.remaining + 'second' +
        ((this.remaining == 1) ? '.' : 's.') );
